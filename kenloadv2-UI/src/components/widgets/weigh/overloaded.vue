...
export default {
  ...
  data() {
    return {
      ...
      orderData: [
        ...
        {
          id: "2",
          datetime: "2021-02-09 11:18:46",
          scalename: "ATHIRIVER MOMBASA BOUND A",
          registration: "MERCEDES BENZ",
          username: "Michael@micna.co.ke",
          deck1: "2000",
          deck2: "2000",
  ...
  computed: {
    ...
    const data={
      ...
      details:`Entering Prosecution details started...`,
