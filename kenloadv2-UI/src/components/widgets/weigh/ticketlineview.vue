...
<template>
  <div class="row">
    ...
    <div
      ...
      :key="data.id"
      :class="data.wbrg_ticket_status == '0' ? 'bodgreen' : 'bg_red'"
    >
      <div
      ...
      >
        <div>
          <img
            :src="getimage(data.wbrg_ticket_date, data.wbrg_ticket_no, 'O')"
            alt="image not found"
            class="rounded zoom"
            height="350"
            style="width: 99%; height: 100%"
      ...
      >
        <div class="card-header" style="width: 100%">
          ...
          >
            ...
            <h5>Axles: {{ data.wbrg_ticket_axel }}</h5>
          </div>
          ...
          <div>
            ...
            <div class="textLarge">
              Time: {{ data.wbrg_ticket_date.substring(11, 20) }}
            </div>
          </div>
        </div>
      ...
      >
              ...
              <div class="textLarge">
                <table class="striped hover">
                  ...
                  <tr>
                    ...
                    <td style="text-align: right">{{ data.axle1_weight }}</td>
                  ...
                  <tr>
                    ...
                    <td style="text-align: right">{{ data.axle2_weight }}</td>
                    <td style="text-align: right">
                      {{ data.axle2_limit }}
                    </td>
                    <td
                      ...
                      :class="
                        data.axle2_weight - data.axle2_limit > 0 ? 'bg_red' : ''
                      "
                    >
                      {{
                  ...
                  <tr>
                    ...
                    <td style="text-align: right">{{ data.axle3_weight }}</td>
                    <td style="text-align: right">
                      {{ data.axle3_limit }}
                    </td>
                    <td style="text-align: right">
                  ...
                  <tr>
                    ...
                    <td style="text-align: right">{{ data.axle4_weight }}</td>
                    <td style="text-align: right">
                      {{ data.axle4_limit }}
                    </td>
                    <td style="text-align: right">
        ...
        >
          ...
          {{ data.wbrg_ticket_directionarea }}
        </div>
      </div>
    </div>
