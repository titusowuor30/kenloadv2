...
export default {
  ...
  methods: {
    ...
    ticketfunctionentry(nodata){
        this.loadImages(nodata,this.viewticket);
    },
    async loadImages(nodata,viewticketcallback)
    {
      ...
      let imgfront3=JSON.stringify(imgfront);
      let imgfront4=JSON.stringify(imgfront2);
     
      //imgfront3 = imgfront3.replace('"','').substring(0,imgfront3.length-1).trim();
      //imgfront4 = imgfront4.replace('"','').substring(0,imgfront3.length-1).trim();
     

      viewticketcallback(nodata,imgfront3,imgfront4);
    },


    async viewticket(nodata,imgfront,imgfront2) {
   
      //alert(imgF);
      imgfront = imgfront.replace('"','').substring(0,imgfront.length-2).trim();
      imgfront2 = imgfront2.replace('"','').substring(0,imgfront2.length-2).trim();
      console.log(imgfront);
      console.log(imgfront2);
          ...
          <div>
            ...
            >
              <template v-slot:cell(action)="data">
                <ul class="list-inline mb-0">
                  <li class="list-inline-item">
                    <button
                      @click="ticketfunctionentry(data.item)"
                      style="
                        color: yellow;
              ...
              <template v-slot:cell(wbrg_ticket_no)="data">
                <a href="#" @click="ticketfunctionentry(data.item)">
                  <p
