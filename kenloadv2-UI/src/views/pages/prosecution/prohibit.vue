...
export default {
  ...
  data() {
    return {
      title: "Prohibit Weighed Vehicle",
      viewProhibited:false,
      items: [
        {
          text: "USER: COP",
        },
        {
          text: "Prohibit Weighed Vehicle",
          active: true,
        },
      ],
      autoClose: "",
      ...
      currentPage: 1,
      perPage: 5,
      pageOptions: [5, 10, 20, 50, 100, 200, 300],
      filter: null,
      filterOn: [],
      sortBy: "id",
      sortDesc: false,
    ...
    const data={
      ...
      details:`Opened prohibited list:${newValue}`,
