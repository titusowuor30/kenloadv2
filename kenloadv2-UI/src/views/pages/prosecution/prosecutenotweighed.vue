...
export default {
  ...
  data() {
    return {
      title: "Charge Vehicle Not Weighed in System",
      items: [
        {
          text: "USER: COP",
        },
        {
          text: "Charge Vehicle Not Weighed",
          active: true,
        },
      ],
      autoClose: "",
  ...
  methods: {
    ...
    goToChargesheet() {
      ...
      newtab.this.$router.push("/ownerchargesheet");
    },
    /**
     * Charge Sheet Driver
     */
    goToChargesheetdriver() {
      ...
      newtab2.this.$router.push("/chargesheet");
    },
    /**
     * EAC WB Certificate
     */
    ...
    <form @submit.prevent="handleSubmit">
      ...
      <div class="card-body">
        ...
        <form>
          <div class="row">
            <div class="col-lg-12">
              <div class="text-end">
                ...
                <b-button v-on:click="goToProsecute()">
                        Close</b-button>
              </div>
            </div>
          </div>
         ...
         <div class="row">
      <button
        class="btn btn-primary waves-effect waves-light col-sm-4"
        @click="goToChargesheet()"
      >
        Generate Owner Chargesheet</button
      >&nbsp;&nbsp;&nbsp;
      <button
        class="btn btn-primary waves-effect waves-light col-sm-4"
        @click="goToChargesheetdriver()"
      >
        Generate Driver Chargesheet
      </button>
    </div>
      </div>
            </div>
