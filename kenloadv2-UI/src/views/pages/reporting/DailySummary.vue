  ...
  data() {
    return {
      ...
      items: [
        ...
        {
          text: "Weighbridge Register Report",
          active: true,
        },
      ],
      ...
      <div class="card-body">
        <form @submit.prevent="handleSubmit">
            ...
            <div class="col-sm-8">
              <div class="row">
                <div class="col-sm-3">
                  <b-button
                    variant="success"
                    v-on:click="goToWbRegisterReport()"
                  >
          ...
          <div align="center">
            ...
            <p>
              <font size="1">
                Blueshield Towers, Hospital Road, Upper Hill P.O. Box 49712 -
                00100 Nairobi <br />
          ...
          <div>
            ...
            <p align="center">
              Report Date: <b>{{ date }} </b> Time:<b>{{ time }}</b>
            </p>
            <hr />
          </div>
          <div class="row">
