...
export default {
      ...
      orderData: [
        {
          id: 1,
          wbt: "ATMBA10499",
          station: "Athiriver Mombasa Bound A",
          vehreg: "KCT455G",
          axleconfig: "6C",
          group1: 5772,
          group2: 17444,
          ...
          pernmissible: 0,
          excess: 0,
          weighedby: "Michael_Kiprotich",
          datetime: "2021-05-16 18:22:38.744",
          state: "1",
          pictogram: "@/assets/images/truckpass.jpg",
        },
        {
          id: 2,
          wbt: "ATMBA10500",
          station: "Athiriver Mombasa Bound B",
          vehreg: "KCM433H",
          axleconfig: "6C",
          group1: 6772,
          group2: 19444,
          ...
          pernmissible: 0,
          weighedby: "Michael_Kiprotich",
          datetime: "2021-05-16 18:25:44.526",
          state: "1",
          pictogram: "@/assets/images/truckpass.jpg",
        },
      ],
  ...
  computed: {
    ...
    const data={
      ...
      details:`Opened overload list:${newValue}`,
    ...
    const data={
      ...
      useremail:curentuser,
      application:window.navigator.userAgent,
      details:`Added Overload:${newValue}`,
      computer:window.localStorage.clientip
    }
     axios
     .post(window.$http + "AuditLogs",data, { headers: window.$headers })
    ...
    const data={
      ...
      useremail:curentuser,
      application:window.navigator.userAgent,
      details:`Edited Overloaded vehicles entry:${newValue}`,
      computer:window.localStorage.clientip
    }
     axios
     .post(window.$http + "AuditLogs",data, { headers: window.$headers })
    ...
    const data={
      ...
      useremail:curentuser,
      application:window.navigator.userAgent,
      details:`Deleted Overloaded vehicles entry:${newValue},entry id:${this.id}`,
      computer:window.localStorage.clientip
    }
     axios
     .post(window.$http + "AuditLogs",data, { headers: window.$headers })
  ...
  methods: {
    defaultvals() {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.complainant = orderData[0].complainant;
    ...
    getticket(
      ...
      doc.text(10, 40, "Overloaded (Multideck)");
    ...
    edit(index, myid, name) {
      //alert(rolename);
      this.editmode = true;
      this.modaltitle = "Edit Overloaded";
      this.id = myid;
      this.name = name;
      this.myindex = index;
      this.focusInput();
    ...
    editrec() {
      if (this.name.trim() == "") {
        Swal.fire("Please enter  Overloaded Name!");
        return;
      }
    ...
    clearvalues() {
      ...
      this.buttonc = true;
      this.buttond = true;
      this.modaltitle = "Add Overloaded";
    },
    setdeck(deck) {
      if (deck == "deck1") {
...
<template>
  <Layout>
                      ...
                      <div class="col-12">
                        ...
                        >
                          ...
                          >
                            ...
                            <template v-slot:cell(state)>
                              <ul class="list-inline mb-0">
                                <li class="list-inline-item">
                                  <img
                                    src="@/assets/images/redbutton.jpg"
                                    alt
                                    height="20"
                                  />
                                </li>
                            ...
                            <template v-slot:cell(pictogram)>
                              <ul class="list-inline mb-0">
                                <li class="list-inline-item">
                                  <img
                                    src="@/assets/images/truckpass.jpg"
                                    alt
                                    height="20"
                                  />
                                </li>
    ...
    <!-- MODAL START-->
    <b-modal id="modal-1" :title="mytitle" hide-footer size="lg" centered>
      <div class="card-body">
        <b-tabs
          pills
          vertical
