...
import autoweighlistview from "@/components/widgets/weigh/autoweighlist";
import Tahoma from "@/assets/fonts/tahoma.ttf";
...
<template>
  <Layout>
    ...
    <div class="card" style="font-size: 11px; font-weight: bold">
      ...
      <autoweighlistview v-show="list" :orderData="orderData" />
    </div>
