...
export default {
  ...
  watch: {
    ...
    addroadauthority(newValue) {
      ...
      const data = {
        ...
        useremail: curentuser,
        application: window.navigator.userAgent,
        details: `Add Organization:${newValue},vale:${this.authority_name}`,
        computer: window.localStorage.clientip,
      };
      axios
        .post(window.$http + "AuditLogs", data, { headers: window.$headers })
    ...
    editroadauthority(newValue) {
      ...
      const data = {
        ...
        useremail: curentuser,
        application: window.navigator.userAgent,
        details: `Edit Organization:${newValue},value:${this.authority_name}`,
        computer: window.localStorage.clientip,
      };
      axios
        .post(window.$http + "AuditLogs", data, { headers: window.$headers })
    ...
    deleteroadauthority(newValue) {
      ...
      const data = {
        ...
        useremail: curentuser,
        application: window.navigator.userAgent,
        details: `Delete Organization:${newValue},authority id:${this.id}`,
        computer: window.localStorage.clientip,
      };
      axios
        .post(window.$http + "AuditLogs", data, { headers: window.$headers })
  ...
  methods: {
    updatearray() {
      ...
      axios
        .get(window.$http + `organization`, { headers: window.$headers })
        .then((response) => {
    ...
    editrec() {
      if (this.authority_name.trim() == "") {
        Swal.fire("Please enter  Organization Name!");
        return;
      }
      ...
      axios
        .put(window.$http + `organization/` + this.id, data, {
    ...
    position() {
      ...
      axios
        .post(window.$http + `organization/`, data, {
          headers: window.$headers,
        })
        .then((response) => {
          // JSON responses are automatically parsed.
    ...
    deleterec(index, id, authority_name) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          axios
            .delete(window.$http + `organization/` + this.id, {
              headers: window.$headers,
            })
            .then((response) => {
              // JSON responses are automatically parsed.
