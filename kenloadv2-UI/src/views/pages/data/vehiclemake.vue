...
export default {
  ...
  data() {
    return {
      title: "Vehicle Make",
      addvehicleMake:false,
      editvehicleMake:false,
      deletevehicleMake:false,
      viewVehicleMake:false,
      clickedPrintpdf:"",
      printedpdf:true,
      generatedExel:"",
      printReport:false,
    ...
    const data={
      ...
      details:`Opened Vehicle make list:${newValue}`,
    ...
    const data={
      ...
      useremail:curentuser,
      application:window.navigator.userAgent,
      details:`Vehicle Make reports:${this.clickedPrintpdf},${this.generatedExel},${this.filteredValues}`,
      computer:window.localStorage.clientip
    }
     axios
     .post(window.$http + "AuditLogs",data, { headers: window.$headers })
    ...
    const data={
      ...
      useremail:curentuser,
      application:window.navigator.userAgent,
      details:`Add vehiclemake:${newValue},value:${this.vehiclemake}`,
      computer:window.localStorage.clientip
    }
     axios
     .post(window.$http + "AuditLogs",data, { headers: window.$headers })
    ...
    const data={
      ...
      useremail:curentuser,
      application:window.navigator.userAgent,
      details:`Edit vehiclemake:${newValue},value:${this.vehiclemake}`,
      computer:window.localStorage.clientip
    }
     axios
     .post(window.$http + "AuditLogs",data, { headers: window.$headers })
    ...
    const data={
      ...
      useremail:curentuser,
      application:window.navigator.userAgent,
      details:`Delete vehicleMake:${newValue},vehicleMake id:${this.id}`,
      computer:window.localStorage.clientip
    }
     axios
     .post(window.$http + "AuditLogs",data, { headers: window.$headers })
  ...
  methods: {
    updatearray() {
      ...
      axios
        .get(window.$http + `VehicleMake`, { headers: window.$headers })
        .then((response) => {
    ...
    editrec() {
      ...
      axios
        .put(window.$http + `VehicleMake/` + this.id, data, {
        ...
        .then((response) => {
          ...
          this.orderData[this.myindex].vehiclemake = this.vehiclemake;
          this.orderData[this.myindex].active = this.active;
          console.log(response.data);
          this.editvehicleMake=true;
    ...
    deleterec(index, id, vehiclemake) {
      //alert(rolename);
      this.id = id;
      this.vehiclemake = vehiclemake;
      Swal.fire({
        title: "Are you sure, you want to delete " + this.vehiclemake + "?",
        ...
        if (result.value) {
          axios
            .delete(window.$http + `VehicleMake/` + this.id, {
              headers: window.$headers,
            })
            .then((response) => {
              // JSON responses are automatically parsed.
              console.log(response.data);
              this.deletevehicleMake=true;
    ...
    clearvalues() {
      this.name = "";
      this.editmode = false;
      this.modaltitle = "Add Vehicle Make";
    },
  },
};
</script>
