...
export default {
  ...
  data() {
    return {
      ...
      id: "",
      addroadauthority:false,
      editroadauthority:false,
      deleteroadauthority:false,
      viewRoadAuthority:false,
      clickedPrintpdf:"",
      printedpdf:true,
      generatedExel:"",
      printReport:false,
    ...
    const data={
      ...
      details:`Opened Road Authorities:${newValue}`,
    ...
    const data={
      ...
      useremail:curentuser,
      application:window.navigator.userAgent,
      details:`Road Authorities reports:${this.clickedPrintpdf},${this.generatedExel},${this.filteredValues}`,
      computer:window.localStorage.clientip
    }
     axios
     .post(window.$http + "AuditLogs",data, { headers: window.$headers })
    ...
    const data={
      ...
      useremail:curentuser,
      application:window.navigator.userAgent,
      details:`Add road authority:${newValue},vale:${this.authority_name}`,
      computer:window.localStorage.clientip
    }
     axios
     .post(window.$http + "AuditLogs",data, { headers: window.$headers })
    ...
    const data={
      ...
      useremail:curentuser,
      application:window.navigator.userAgent,
      details:`Edit road authority:${newValue},value:${this.authority_name}`,
      computer:window.localStorage.clientip
    }
     axios
     .post(window.$http + "AuditLogs",data, { headers: window.$headers })
    ...
    const data={
      ...
      useremail:curentuser,
      application:window.navigator.userAgent,
      details:`Delete road authority:${newValue},authority id:${this.id}`,
      computer:window.localStorage.clientip
    }
     axios
     .post(window.$http + "AuditLogs",data, { headers: window.$headers })
  ...
  methods: {
    updatearray() {
      ...
      axios
        .get(window.$http + `RoadAuthorities`, { headers: window.$headers })
        .then((response) => {
    ...
    edit(index, myid, authority_name) {
      //alert(rolename);
      this.editmode = true;
    ...
    editrec() {
      ...
      axios
        .put(window.$http + `RoadAuthorities/` + this.id, data, {
          headers: window.$headers,
        })
        .then((response) => {
          // JSON responses are automatically parsed.
          this.orderData[this.myindex].id = this.id;
          this.orderData[this.myindex].authority_name = this.authority_name;
          this.orderData[this.myindex].active = this.active;
          console.log(response.data);
          this.editroadauthority=true;
    ...
    position() {
      ...
      axios
        .post(window.$http + `RoadAuthorities/`, data, {
          headers: window.$headers,
        })
        .then((response) => {
          // JSON responses are automatically parsed.
          console.log(response.data);
          this.addroadauthority=true;
          Swal.fire({
            position: "center",
            icon: "success",
            title: "Your work has been saved",
    ...
    deleterec(index, id, authority_name) {
      //alert(rolename);
      this.id = id;
      this.authority_name = authority_name;
      Swal.fire({
        title: "Are you sure, you want to delete " + this.authority_name + "?",
        ...
        if (result.value) {
          axios
            .delete(window.$http + `RoadAuthorities/` + this.id, {
              headers: window.$headers,
            })
            .then((response) => {
              // JSON responses are automatically parsed.
              console.log(response.data);
              this.deleteroadauthority=true;
              this.orderData.splice(index, 1);
              Swal.fire(
                this.authority_name + " Deleted!",
                          ...
                          >
                            <template v-slot:cell(screens)="data">
                              <a
                                ...
                                v-for="authority in data.item.authority_name"
                                :key="authority"
                                >{{ authority }} <br
                              /></a>
                            </template>
            ...
            <div class="card-body">
              <form @submit.prevent="handleSubmit">
                <div class="row">
                  ...
                  <div class="input-group">
                    <div class="input-group-text col-sm-4">Authority Name:</div>
