...
export default {
  ...
  data() {
    return {
      title: "Cluster Weighbridge",
      addclustrewblogs: false,
      editclustrewblogs: false,
      deleteclustrewblogs: false,
      viewClusterWB: false,
      cluster_name: "",
      cluster_code: "",
      clickedPrintpdf: "",
  ...
  watch: {
    viewClusterWB(newValue) {
      ...
      const data = {
        ...
        details: `Opened Cluster weighbridge list:${newValue}`,
    ...
    printReport() {
      ...
      const data = {
        ...
        useremail: curentuser,
        application: window.navigator.appCodeName,
        details: `Cluster weigghbridge reports:${this.clickedPrintpdf},${this.generatedExel},${this.filteredValues}`,
        computer: window.localStorage.clientip,
      };
      axios
        .post(window.$http + "AuditLogs", data, { headers: window.$headers })
    ...
    addclustrewblogs(newValue) {
      ...
      const data = {
        ...
        useremail: curentuser,
        application: window.navigator.appCodeName,
        details: `Add clusterWB:${newValue},value:${this.cluster_name}`,
        computer: window.localStorage.clientip,
      };
      axios
        .post(window.$http + "AuditLogs", data, { headers: window.$headers })
    ...
    editclustrewblogs(newValue) {
      ...
      const data = {
        ...
        useremail: curentuser,
        application: window.navigator.appCodeName,
        details: `Edit clusterWB:${newValue},value:${this.cluster_name}`,
        computer: window.localStorage.clientip,
      };
      axios
        .post(window.$http + "AuditLogs", data, { headers: window.$headers })
    ...
    deleteclustrewblogs(newValue) {
      ...
      const data = {
        ...
        useremail: curentuser,
        application: window.navigator.appCodeName,
        details: `Delete clusterWB:${newValue},cluster code:${this.id}`,
        computer: window.localStorage.clientip,
      };
      axios
        .post(window.$http + "AuditLogs", data, { headers: window.$headers })
  ...
  methods: {
    updatearray() {
      ...
      axios
        .get(window.$http + `ClusterWeighbridges`, { headers: window.$headers })
        .then((response) => {
    ...
    edit(index, myid, cluster_name, cluster_code) {
      //alert(rolename);
      this.editmode = true;
      this.modaltitle = "Edit Weighbridges";
      this.id = myid;
    ...
    editrec() {
      if (this.cluster_name.trim() == "") {
        Swal.fire("Please enter  Weighbidges Name!");
        return;
      }

      if (this.cluster_code.trim() == "") {
        Swal.fire("Please enter  Weighbidges Code!");
        return;
      }
      ...
      axios
        .put(window.$http + `ClusterWeighbridges/` + this.id, data, {
          headers: window.$headers,
        })
        .then((response) => {
          // JSON responses are automatically parsed.
          this.editclustrewblogs = true;
          Swal.fire({
            position: "center",
            icon: "success",
    ...
    position() {
      if (this.cluster_name.trim() == "") {
        Swal.fire("Please enter  Weighbridges Name!");
        return;
      }
      if (this.cluster_code.trim() == "") {
        Swal.fire("Please enter  Weighbridges code!");
        return;
      }
      ...
      axios
        .post(window.$http + `ClusterWeighbridges/`, data, {
          headers: window.$headers,
        })
        .then((response) => {
          // JSON responses are automatically parsed.
          console.log(response.data);
          this.addclustrewblogs = true;
          this.updatearray();
          Swal.fire({
            position: "center",
            icon: "success",
    ...
    deleterec(index, id, cluster_name) {
      //alert(rolename);
      this.id = id;
      this.cluster_name = cluster_name;
      Swal.fire({
        title: "Are you sure, you want to delete " + this.cluster_name + "?",
        ...
        if (result.value) {
          axios
            .delete(window.$http + `ClusterWeighbridges/` + this.id, {
              headers: window.$headers,
            })
            .then(() => {
              // JSON responses are automatically parsed.
              ...
              this.deleteclustrewblogs = true;

              Swal.fire(
                this.cluster_name + " Deleted!",
    ...
    clearvalues() {
      this.editmode = false;
      this.modaltitle = "Add Weighbridge";
    },
  },
};
</script>
                          ...
                          >
                            <template v-slot:cell(screens)="data">
                              <a
                                ...
                                v-for="weighbridges in data.item.cluster_name"
                                :key="weighbridges"
                                >{{ weighbridges }} <br
                              /></a>
                            </template>
                                  ...
                                  <a
                                    ...
                                    @click="
                                      edit(
                                        data.index,
                                        data.item.id,
                                        data.item.cluster_name,
                                        data.item.cluster_code
                                      )
                                    "
                                  >
