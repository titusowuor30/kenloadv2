...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        {
          key: "vehicle_permit_no",
          label: "Permit no",
          sortable: true,
        },
        {
          key: "vehicle_permitissued_date",
          label: "Permit Date",
          sortable: true,
        },
        {
          key: "vehicle_permitexpiration_date",
    ...
    const data={
      ...
      details:`Opened Vehicles' list:${newValue}`,
    ...
    const data={
      ...
      useremail:curentuser,
      application:window.navigator.userAgent,
      details:`Vehicles reports:${this.clickedPrintpdf},${this.generatedExel},${this.filteredValues}`,
      computer:window.localStorage.clientip
    }
     axios
     .post(window.$http + "AuditLogs",data, { headers: window.$headers })
    ...
    const data={
      ...
      useremail:curentuser,
      application:window.navigator.userAgent,
      details:`Add vehicle:${newValue},value:${this.id}`,
      computer:window.localStorage.clientip
    }
     axios
     .post(window.$http + "AuditLogs",data, { headers: window.$headers })
    ...
    const data={
      ...
      useremail:curentuser,
      application:window.navigator.userAgent,
      details:`Edit vehicle:${newValue},id:${this.id}`,
      computer:window.localStorage.clientip
    }
     axios
     .post(window.$http + "AuditLogs",data, { headers: window.$headers })
    ...
    const data={
      ...
      useremail:curentuser,
      application:window.navigator.userAgent,
      details:`Delete vehicle:${newValue},vehicle id:${this.id}`,
      computer:window.localStorage.clientip
    }
     axios
     .post(window.$http + "AuditLogs",data, { headers: window.$headers })
  ...
  methods: {
    updatearray() {
      ...
      axios
        .get(window.$http + `Vehicles`, { headers: window.$headers })
        .then((response) => {
    ...
    editrec() {
      ...
      axios
        .put(window.$http + `Vehicles/` + this.id, data, {
          headers: window.$headers,
        })
        .then((response) => {
          // JSON responses are automatically parsed.
          this.orderData[this.myindex].id = this.id;
          this.orderData[this.myindex].vehicle_name = this.vehicle_name;
    ...
    deleterec(index, id, vehicle_name) {
      //alert(rolename);
      this.id = id;
      this.vehicle_name = vehicle_name;
      Swal.fire({
        title: "Are you sure, you want to delete " + this.vehicle_name + "?",
        ...
        if (result.value) {
          axios
            .delete(window.$http + `Vehicles/` + this.id, {
              headers: window.$headers,
            })
            .then((response) => {
              // JSON responses are automatically parsed.
    ...
    search() {
      ...
      axios
        .get(window.$http + `vehicles/search?vehicle_reg=` + this.filter, {
          headers: window.$headers,
        })
        .then((response) => {
          // JSON responses are automatically parsed.
                          ...
                          >
                            <template v-slot:cell(screens)="data">
                              <a
                                ...
                                v-for="screen in data.item.vehicle_name"
                                :key="screen"
                                >{{ screen }} <br
                              /></a>
                            </template>
            ...
            <div class="card-body">
              <form @submit.prevent="handleSubmit">
                <div class="row">
                  ...
                  <div class="input-group">
                    <div class="input-group-text col-sm-4">Vehicle Name:</div>
