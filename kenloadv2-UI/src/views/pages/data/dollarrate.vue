...
export default {
  ...
  methods: {
    updatearray() {
      ...
      axios
        .get(window.$http + `dollarrate`, { headers: window.$headers })
        .then((response) => {
          ...
          if (this.orderData.length > 0) {
            ...
            this.dollarrate = this.orderData[this.totalRows].rate;
          }
          Swal.close();
        })
        .catch((e) => {
    ...
    getticket(
      ...
      doc.text(10, 40, "Dollar Rate (Multideck)");
    ...
    edit(index, myid, name) {
      //alert(rolename);
      this.editmode = true;
      this.modaltitle = "Edit Dollar Rate";
      this.id = myid;
      this.name = name;
      this.myindex = index;
      this.focusInput();
    ...
    editrec() {
      if (this.name.trim() == "") {
        Swal.fire("Please enter  Dollar Rate Name!");
        return;
      }
    ...
    position() {
      ...
      var str = "<div> Dollar Rate:" + this.dollarrate + "</div>" + "<br>";
      Swal.fire({
        title: "Do you want to save Dollar Rate \n" + "?",
        html: "<pre>" + str + "</pre>",
        ...
        if (result.value) {
          ...
          axios
            .post(window.$http + `dollarrate/`, data, {
    ...
    clearvalues() {
      ...
      this.buttonc = true;
      this.buttond = true;
      this.modaltitle = "Add Dollar Rate";
    },
    setdeck(deck) {
      if (deck == "deck1") {
                  ...
                  <div class="card">
                    <div class="card-body changebg">
                      ...
                      <div class="input-group">
                        <div class="input-group-text col-sm-4">Dollar Rate</div>
